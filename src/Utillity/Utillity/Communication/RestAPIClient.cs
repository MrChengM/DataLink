...
namespace Utillity.Communication
{
    public class RestAPIClient
    {
        ...
        public static T2 GetFuncJson<T1,T2>(string url,T1 body, string authorization = null)
        {
            string bodyStr = JsonConvert.SerializeObject(body);
            var content = CommomRequestFunc(url, "GET", bodyStr, authorization);
        ...
        public static T2 DeleteFuncJson<T1,T2>(string url,T1 body, string authorization = null)
        {
            string bodyStr = JsonConvert.SerializeObject(body);
            var content = CommomRequestFunc(url, "DELETE", bodyStr, authorization);
            return JsonConvert.DeserializeObject<T2>(content);
        }
