...
namespace WCFRestFullAPI.Json
{
    public class NewtonsoftJsonBehavior : WebHttpBehavior
    {
        ...
        {
            if (this.IsGetOrDeleteOperation(operationDescription))
            {
            ...
            return new NewtonsoftJsonDispatchFormatter(operationDescription, endpoint, GetBodyStyle(operationDescription), true);
        }
        ...
        protected override IDispatchMessageFormatter GetReplyDispatchFormatter(OperationDescription operationDescription, ServiceEndpoint endpoint)
        {
            ...
            {
                return new NewtonsoftJsonDispatchFormatter(operationDescription, endpoint, GetBodyStyle(operationDescription), false);
            }
        }
        ...
        private void ValidateOperation(OperationDescription operation)
        {
            ...
            if (!this.IsGetOrDeleteOperation(operation))
            {
        ...
        private bool IsGetOrDeleteOperation(OperationDescription operation)
        {
            WebGetAttribute wga = operation.Behaviors.Find<WebGetAttribute>();
            if (wga != null)
            {
            ...
            if (wia != null)
            {
                return wia.Method == "HEAD"|| wia.Method=="GET"||wia.Method=="DELETE";
            }
            return false;
        }
    }
